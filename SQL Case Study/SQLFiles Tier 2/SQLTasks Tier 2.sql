...
the member name. */
SELECT DISTINCT CONCAT(m.firstname, ' ', m.surname, ' - ', f.name) AS member_facility_name
FROM Members AS m
INNER JOIN Bookings AS b ON m.memid = b.memid
INNER JOIN Facilities AS f ON b.facid = f.facid
WHERE f.name LIKE 'Tennis Court%'
ORDER BY member_facility_name;
...
WHERE Bookings.starttime >= '2012-09-14' AND Bookings.starttime < '2012-09-15'
      AND (Bookings.slots * Facilities.membercost > 30 OR Bookings.slots * Facilities.guestcost > 30)
ORDER BY cost DESC;
